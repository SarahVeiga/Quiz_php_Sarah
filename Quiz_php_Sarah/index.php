...
// Obtém o parãmetro 'route' da URL (caso exista). Se não existir, defina 'start' como o valor padrão.
...
switch ($route) {
    ...
    case 'start':
        $script = 'start'; // Define que o script para a página inicial do jogo.
        break;
...
// Carrega o arquivo de dados das capitais, que contém umalista ou array com os países e suas capitais.
