...
if ($_SERVER ['REQUEST_METHOD'] === 'POST') {
    ...
    // Chama a função 'prepare game' para preparar os dados do jogo com o número de questões definido. 
...
function prepare_game($total_questions)
{
    ...
    // Gera um ID aleatório dentro do intervalo de índices do array Scapitals.
...
<div class="container">
    <div class="row">
        ...
        <form action="index.php?route=start" method="post">
            ...
            <!-- O valor inicial é 10, o mínimo é 1 e o máximo é 20. -->
